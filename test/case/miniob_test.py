...
python3 miniob_test.py --test-cases=primary-aggregation-func --report-only
python3 miniob_test.py --test-cases=primary-date --report-only
python3 miniob_test.py --test-cases=primary-simple-sub-query --report-only
python3 miniob_test.py --test-cases=primary-order-by --report-only
python3 miniob_test.py --test-cases=primary-null --report-only
