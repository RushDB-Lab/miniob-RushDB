...
int LeafIndexNodeHandler::lookup(const KeyComparator &comparator, const char *key, bool *found /* = nullptr */) const
{
  ...
  unique_KeyComparator         unique_KeyComp;
  if (unique_index) {
    iter = lower_bound(iter_begin, iter_end, key, unique_KeyComp, found);
  } else {
    iter = lower_bound(iter_begin, iter_end, key, comparator, found);
  }*/
