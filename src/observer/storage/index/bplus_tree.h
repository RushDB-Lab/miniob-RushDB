...
class Unique_KeyComparator : public KeyComparator
{
public:
  void init(AttrType type, int length) { attr_comparator_.init(type, length); }
...
public:
  ...
  std::string operator()(const char *v) const
  {
    switch (attr_type_) {
      ...
      case DATES: {
        std::string base = std::to_string(*(int *)v);
...
public:
  ...
  void init_unique_index(bool unique_index_) { unique_index = unique_index_; }
...
protected:
  ...
  Unique_KeyComparator unique_key_comparator_;
