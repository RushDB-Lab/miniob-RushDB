...
RC BplusTreeIndex::create(
    const char *file_name, const IndexMeta &index_meta, const FieldMeta &field_meta, bool unique_index_)
{
  if (inited_) {
  ...
  // 初始化handler的unique_index
  index_handler_.init_unique_index(unique_index);
