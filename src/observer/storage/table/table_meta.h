...
public:
  ...
  const FieldMeta              *field_num(int num) const;
  const FieldMeta              *find_field_by_offset(int offset) const;
  int                           find_offset_by_name(std::string att_name);
  int                           find_att_len(std::string att_name);
  AttrType                      find_att_by_name(std::string att_name);
  ...
  int              find__attry(std::string att_name);
...
public:
  ...
  int  fiele_size() { return fields_.size(); }
  int  find_index_by_name(std::string att_name) const;
