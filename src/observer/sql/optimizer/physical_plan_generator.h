...
private:
  ...
  RC create_plan(ShowIndexLogicalOperator &show_index_oper, std::unique_ptr<PhysicalOperator> &oper);
  RC create_plan(AggFuncLogicalOperator &Agg_Func_oper, std::unique_ptr<PhysicalOperator> &oper);
  RC create_plan(OrderByLogicalOperator &insert_oper, unique_ptr<PhysicalOperator> &oper);
};
