...
struct ConditionSqlNode
{
  ...
  SelectSqlNode *sub_select  = nullptr;  ///< in的子查询
  bool           is_like     = false;
...
struct SelectSqlNode
{
  ...
  std::vector<OrderBy>          order_bys;   ///< 对输出结果排序的要求的排序条件
  struct InnerListNode          inner;       ///< inner join 的必要文件
};
...
struct AttrInfoSqlNode
{
  ...
  bool        can_be_null = true;  ///< Can Attribute  be the null
};
