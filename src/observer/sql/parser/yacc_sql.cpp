...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_nullable_constraint = 91,       /* nullable_constraint  */
...
static const yytype_int16 yyrline[] =
{
     ...
     287,   294,   300,   308,   318,   332,   342,   366,   369,   382,
     394,   419,   423,   428,   434,   437,   438,   439,   440,   444,
     457,   463,   470,   476,   484,   488,   492,   498,   505,   508,
     515,   527,   541,   547,   555,   565,   594,   627,   636,   645,
     661,   664,   667,   670,   673,   682,   685,   690,   696,   699,
     702,   709,   712,   715,   720,   728,   735,   742,   747,   757,
     763,   773,   790,   797,   809,   812,   818,   822,   826,   833,
     834,   835,   836,   837,   838,   839,   840,   841,   842,   843,
     844,   849,   852,   860,   865,   873,   879,   885,   895,   900,
     913,   921,   931,   932
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DATE_T", "NOT", "NULL_T", "NULLABLE", "HELP", "EXIT", "DOT", "INTO",
  "VALUES", "FROM", "WHERE", "AND", "OR", "SET", "ON", "LOAD", "DATA",
  "INFILE", "EXPLAIN", "STORAGE", "FORMAT", "INNER", "JOIN", "EQ", "LT",
  "GT", "LE", "GE", "NE", "LIKE", "IS", "NUMBER", "FLOAT", "ID", "SSS",
  "'+'", "'-'", "'*'", "'/'", "UMINUS", "$accept", "commands",
  "command_wrapper", "exit_stmt", "help_stmt", "sync_stmt", "begin_stmt",
  "commit_stmt", "rollback_stmt", "drop_table_stmt", "show_tables_stmt",
  "desc_table_stmt", "show_index_stmt", "create_index_stmt",
  "drop_index_stmt", "create_table_stmt", "attr_def_list", "attr_def",
  "nullable_constraint", "number", "type", "insert_stmt", "values_list",
  ...
  "opt_order_by", "sort_list", "sort_unit", "group_by", "load_data_stmt",
...
{
     135,    24,    72,    66,    66,   -58,    67,  -153,   -26,   -20,
     -37,  -153,  -153,  -153,  -153,  -153,   -35,    -7,   135,    45,
      48,  -153,  -153,  -153,  -153,  -153,  -153,  -153,  -153,  -153,
    -153,  -153,  -153,  -153,  -153,  -153,  -153,  -153,  -153,  -153,
    -153,  -153,   -10,    -1,    11,    19,   -12,  -153,  -153,  -153,
     -13,  -153,    66,  -153,  -153,  -153,    -2,  -153,  -153,  -153,
      49,  -153,  -153,    68,    43,    50,    15,    61,    64,  -153,
    -153,  -153,  -153,    92,    71,  -153,    73,    95,    97,    59,
      56,  -153,    74,  -153,    66,    66,    66,    66,   102,    75,
      75,    93,    94,    78,    -5,    79,    82,   100,   101,  -153,
    -153,  -153,   114,  -153,  -153,    29,    29,  -153,  -153,    66,
    -153,    21,    94,  -153,   116,    66,  -153,    89,   -19,  -153,
    -153,   118,    17,   144,   136,  -153,  -153,  -153,   105,   145,
    -153,    -5,   146,   134,    58,    -5,    78,  -153,   162,  -153,
    -153,  -153,  -153,     5,    82,   151,   110,    75,    75,   166,
      80,  -153,   155,  -153,   -25,  -153,  -153,  -153,  -153,  -153,
    -153,  -153,   148,    66,    66,    66,  -153,  -153,   113,   120,
     150,  -153,  -153,   144,   128,   163,   141,    94,    12,  -153,
     183,  -153,  -153,    -5,    -5,  -153,  -153,  -153,    27,  -153,
     154,  -153,  -153,   175,  -153,  -153,   147,  -153,  -153,    66,
    -153,    66,  -153,    83,    54,   152,   -27,  -153,     2,  -153,
     176,  -153,  -153,   140,   156,  -153,  -153,    66,  -153,    75,
    -153,  -153
};
...
static const yytype_int8 yydefact[] =
{
     ...
     122,    23,    22,    15,    16,    17,    18,     9,    10,    11,
      ...
      87,    56,     0,    78,    76,    67,    81,    79,    80,    77,
       0,    32,    31,     0,     0,     0,     0,     0,     0,   120,
       1,   123,     2,     0,     0,    30,     0,     0,     0,     0,
       0,    75,     0,    82,     0,     0,     0,     0,    68,     0,
       0,     0,    94,     0,     0,     0,     0,     0,     0,    86,
      74,    85,     0,    88,    83,    70,    71,    72,    73,     0,
      89,    81,    94,    33,     0,     0,    60,     0,    94,    62,
     121,     0,     0,    37,     0,    35,    84,    69,     0,    90,
     118,     0,    49,     0,    95,     0,     0,    61,     0,    45,
      46,    47,    48,    43,     0,     0,     0,     0,     0,   111,
       0,    52,     0,   109,     0,    99,   100,   101,   102,   103,
     104,   107,   105,     0,     0,     0,    64,    63,     0,     0,
       0,    42,    40,    37,    58,     0,     0,    94,    81,    91,
       0,    65,    50,     0,     0,   110,   108,   106,    96,    97,
      98,   119,    44,     0,    41,    38,     0,    36,    34,     0,
     118,     0,    53,     0,    43,     0,    92,    66,   115,   112,
     113,    51,    39,     0,     0,   117,   116,     0,    59,     0,
     114,    93
};
...
{
    -153,  -153,   189,  -153,  -153,  -153,  -153,  -153,  -153,  -153,
    -153,  -153,  -153,  -153,  -153,  -153,    36,    69,     6,  -153,
    -153,  -153,  -153,    28,   -91,  -153,  -153,  -153,  -153,    81,
     168,  -153,    -3,   -52,   159,  -153,  -153,  -153,   -69,    70,
       0,  -103,  -152,  -153,  -153,     3,  -153,    16,  -153,  -153,
    -153,  -153
};
...
static const yytype_uint8 yydefgoto[] =
{
      ...
      28,    29,    30,    31,    32,    33,   145,   123,   172,   193,
     143,    34,   132,   150,    54,   197,    35,    36,   118,   119,
      37,    38,    55,    56,   129,    57,    58,    59,   176,   112,
     177,   116,   134,   163,   181,   209,   210,   149,    39,    40,
      41,    72
};
...
{
      81,    60,    82,   120,     4,   185,   136,   215,    61,   130,
      79,    46,   189,   190,    64,   137,    82,   164,   165,   216,
     111,   113,    65,    47,   115,    82,    80,   214,   169,    66,
      47,    67,   105,   106,   107,   108,    42,   186,    43,   170,
     151,   171,    68,    78,   166,    70,   139,   206,   140,   141,
     142,    71,    48,    49,    50,    51,    73,    52,    53,    48,
      49,    93,    51,   133,    83,    74,    84,    85,    86,    87,
      84,    85,    86,    87,   200,   128,   102,    75,    83,   178,
      62,    63,    46,   101,    44,    76,    45,    83,   170,    46,
     171,    89,   202,   151,    47,    84,    85,    86,    87,    86,
      87,    47,   164,   165,   182,   183,   127,   211,   183,    91,
      90,   188,   133,   133,    95,    96,    92,    94,    97,    99,
      98,   100,   103,    48,    49,    50,    51,   109,    52,    53,
      48,    49,    50,    51,   114,    52,    53,   115,   126,   131,
     104,   110,     1,     2,   117,   135,   121,   133,   122,   208,
       3,     4,     5,     6,     7,     8,     9,    10,   138,   146,
     147,    11,    12,    13,   153,   208,   124,   125,   154,   144,
     148,   152,    14,    15,   168,   174,   175,   180,   184,   191,
     196,    16,   187,    17,   192,   194,    18,   198,   199,   201,
     155,   156,   157,   158,   159,   160,   161,   162,   164,   204,
     205,   217,    84,    85,    86,    87,   218,    69,   213,   195,
     212,   219,   203,   173,    77,    88,   207,   167,   179,   221,
     220
};

static const yytype_uint8 yycheck[] =
{
      52,     4,     4,    94,    16,    30,    25,     5,    66,   112,
      23,    23,   164,   165,    40,   118,     4,    44,    45,    17,
      89,    90,    42,    35,    43,     4,    39,    54,    23,    66,
      35,    66,    84,    85,    86,    87,    12,    62,    14,    34,
     131,    36,    49,    46,   135,     0,    29,   199,    31,    32,
      33,     3,    64,    65,    66,    67,    66,    69,    70,    64,
      65,    46,    67,   115,    66,    66,    68,    69,    70,    71,
      68,    69,    70,    71,   177,    54,    79,    66,    66,   148,
      13,    14,    23,    24,    12,    66,    14,    66,    34,    23,
      36,    42,   183,   184,    35,    68,    69,    70,    71,    70,
      71,    35,    44,    45,    24,    25,   109,    24,    25,    66,
      42,   163,   164,   165,    50,    23,    66,    56,    47,    24,
      47,    24,    66,    64,    65,    66,    67,    25,    69,    70,
      64,    65,    66,    67,    41,    69,    70,    43,    24,    23,
      66,    66,     7,     8,    66,    56,    67,   199,    66,   201,
      15,    16,    17,    18,    19,    20,    21,    22,    40,    23,
      55,    26,    27,    28,    30,   217,    66,    66,    34,    25,
      25,    25,    37,    38,    12,    24,    66,    11,    23,    66,
      52,    46,    34,    48,    64,    35,    51,    24,    47,     6,
      56,    57,    58,    59,    60,    61,    62,    63,    44,    24,
      53,    25,    68,    69,    70,    71,    66,    18,    56,   173,
     204,    55,   184,   144,    46,    56,   200,   136,   148,   219,
     217
};
...
static const yytype_int8 yystos[] =
{
      ...
      22,    26,    27,    28,    37,    38,    46,    48,    51,    74,
      75,    76,    77,    78,    79,    80,    81,    82,    83,    84,
      85,    86,    87,    88,    94,    99,   100,   103,   104,   121,
     122,   123,    12,    14,    12,    14,    23,    35,    64,    65,
      66,    67,    69,    70,    97,   105,   106,   108,   109,   110,
     105,    66,    13,    14,    40,    42,    66,    66,    49,    75,
       0,     3,   124,    66,    66,    66,    66,   103,   105,    23,
      39,   106,     4,    66,    68,    69,    70,    71,   107,    42,
      42,    66,    66,    46,    56,    50,    23,    47,    47,    24,
      24,    24,   105,    66,    66,   106,   106,   106,   106,    25,
      66,   111,   112,   111,    41,    43,   114,    66,   101,   102,
      97,    67,    66,    90,    66,    66,    24,   105,    54,   107,
     114,    23,    95,   106,   115,    56,    25,   114,    40,    29,
      31,    32,    33,    93,    25,    89,    23,    55,    25,   120,
      96,    97,    25,    30,    34,    56,    57,    58,    59,    60,
      61,    62,    63,   116,    44,    45,    97,   102,    12,    23,
      34,    36,    91,    90,    24,    66,   111,   113,   111,   112,
      11,   117,    24,    25,    23,    30,    62,    34,   106,   115,
     115,    66,    64,    92,    35,    89,    52,    98,    24,    47,
     114,     6,    97,    96,    24,    53,   115,   120,   106,   118,
     119,    24,    91,    56,    54,     5,    17,    25,    66,    55,
     118,   113
};
...
#line 2229 "yacc_sql.cpp"
  ...
  case 65: /* select_stmt: SELECT expression_list FROM rel_list where group_by opt_order_by  */
#line 566 "yacc_sql.y"
    {
...
#line 2459 "yacc_sql.cpp"
  ...
  case 84: /* aggr_func_expr: ID LBRACE expression_list RBRACE  */
#line 721 "yacc_sql.y"
    {
        if((*(yyvsp[-1].expression_list)).size() != 1) {
...
#line 2471 "yacc_sql.cpp"
  ...
  case 85: /* aggr_func_expr: ID LBRACE RBRACE  */
#line 729 "yacc_sql.y"
     {
        (yyval.expression) = new UnboundAggregateExpr("max",new StarExpr() );
     }
#line 2479 "yacc_sql.cpp"
  ...
  case 86: /* sub_query_expr: LBRACE select_stmt RBRACE  */
#line 736 "yacc_sql.y"
    {
...
#line 2517 "yacc_sql.cpp"
  ...
  case 90: /* rel_list: relation alias  */
#line 763 "yacc_sql.y"
                   {
...
#line 2532 "yacc_sql.cpp"
  ...
  case 91: /* rel_list: relation alias COMMA rel_list  */
#line 773 "yacc_sql.y"
                                    {
...
#line 2551 "yacc_sql.cpp"
  ...
  case 92: /* joinClauses: relation ON condition  */
#line 791 "yacc_sql.y"
    {
...
#line 2562 "yacc_sql.cpp"
  ...
  case 93: /* joinClauses: relation ON condition INNER JOIN joinClauses  */
#line 798 "yacc_sql.y"
    {
...
#line 2694 "yacc_sql.cpp"
  ...
  case 112: /* opt_order_by: ORDER BY sort_list  */
#line 853 "yacc_sql.y"
    {
...
#line 2712 "yacc_sql.cpp"
  ...
  case 114: /* sort_list: sort_unit COMMA sort_list  */
#line 866 "yacc_sql.y"
        {
...
#line 2731 "yacc_sql.cpp"
  ...
  case 116: /* sort_unit: expression DESC  */
#line 880 "yacc_sql.y"
        {
      (yyval.orderby_unit) = new OrderBySqlNode();
...
#line 2741 "yacc_sql.cpp"
  ...
  case 117: /* sort_unit: expression ASC  */
#line 886 "yacc_sql.y"
        {
